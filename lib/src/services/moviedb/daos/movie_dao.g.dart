...
MovieDAO _$MovieDAOFromJson(Map<String, dynamic> json) => MovieDAO(
      ...
      belongsToCollection: json['belongs_to_collection'] == null
          ? null
          : CollectionDAO.fromJson(
              json['belongs_to_collection'] as Map<String, dynamic>),
      budget: json['budget'] as int?,
      genres: (json['genres'] as List<dynamic>?)
          ?.map((e) => GenreDAO.fromJson(e as Map<String, dynamic>))
          .toList(),
      ...
      productionCompanies: (json['production_companies'] as List<dynamic>?)
          ?.map((e) => CompanyDAO.fromJson(e as Map<String, dynamic>))
          .toList(),
      ...
      spokenLanguages: (json['spoken_languages'] as List<dynamic>?)
          ?.map((e) => LanguageDAO.fromJson(e as Map<String, dynamic>))
          .toList(),
